...
export default function FacilitiesManagerRegisterPage() {
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-sky-950/40 to-slate-950 flex flex-col justify-between py-10 px-4">
      ...
      <div className="w-full max-w-2xl mx-auto my-auto">
        ...
        {step === 1 ? (
          <Card theme="dark" noPad className="p-8 border border-sky-500/20 bg-slate-900/60 backdrop-blur-md shadow-2xl">
            <div className="flex flex-col items-center gap-3 mb-6">
              ...
              <div className="text-center">
                <h1 className="text-2xl font-extrabold text-white tracking-tight">Facilities Manager Signup</h1>
            ...
            <form className="space-y-5" onSubmit={onSubmit}>
                ...
                <FormField>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white placeholder-slate-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 disabled:opacity-50"
                    />
                          ...
                          .map((inst) => (
                            <li key={inst.id}>
                              <button
                                ...
                                className="w-full px-3 py-2 text-left text-sm text-slate-200 hover:bg-sky-500/20 hover:text-sky-300 transition-colors"
                              >
                                {inst.name}
                              </button>
                            </li>
                  ...
                  <FormField>
                    ...
                    {campusesLoading ? (
                      ...
                      <select
                        ...
                        required
                        className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2.5 text-sm text-white focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500"
                      >
              ...
              <Button
                ...
                fullWidth
                loading={loading}
                className="mt-1 bg-gradient-to-r from-sky-600 to-blue-600 border-none"
              >
              ...
              <p className="text-sm text-slate-400 text-center">
                ...
                <Link href="/admin/facilities-manager/login" className="font-bold text-sky-450 hover:text-sky-300 hover:underline">
                  Sign in here
                </Link>
              </p>
            </form>
          ...
          <Card theme="dark" noPad className="p-8 flex flex-col items-center gap-6 border border-sky-500/20 bg-slate-900/60 backdrop-blur-md shadow-2xl">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400 mt-2">
                Your <span className="font-semibold text-sky-400">Facilities Manager</span> account for{" "}
            ...
            <Button
              ...
              size="lg"
              fullWidth
              onClick={() => router.push("/admin/facilities-manager/login")}
              className="bg-gradient-to-r from-sky-600 to-blue-600 border-none"
            >
