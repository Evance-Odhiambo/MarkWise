...
export default function AcademicRegistrarRegisterPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950/40 to-slate-950 flex flex-col justify-between py-10 px-4">
      {/* Top Section */}
      ...
      <div className="w-full max-w-2xl mx-auto my-auto">
        ...
        {step === 1 ? (
          <Card theme="dark" noPad className="p-8 border border-violet-500/20 bg-slate-900/60 backdrop-blur-md shadow-2xl">
            <div className="flex flex-col items-center gap-3 mb-6">
              <div className="flex items-center justify-center h-14 w-14 rounded-2xl bg-violet-500/10 border border-violet-500/20 text-violet-400 shadow-lg shadow-violet-500/5">
                <BookOpen className="h-7 w-7" />
              </div>
              <div className="text-center">
                <h1 className="text-2xl font-extrabold text-white tracking-tight">Academic Registrar Signup</h1>
                <p className="text-sm text-slate-400 mt-1">
                  Create your account under your institution and campus
                </p>
              </div>
            </div>
            ...
            <form className="space-y-5" onSubmit={onSubmit}>
                ...
                <FormField>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white placeholder-slate-500 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500 disabled:opacity-50"
                    />
                  ...
                  <FormField>
                    ...
                    {campusesLoading ? (
                      ...
                      <select
                        ...
                        required
                        className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2.5 text-sm text-white focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500"
                      >
              ...
              <Button
                ...
                fullWidth
                loading={loading}
                className="mt-1 bg-gradient-to-r from-violet-600 to-fuchsia-600 border-none"
              >
              ...
              <p className="text-sm text-slate-400 text-center">
                ...
                <Link href="/admin/academic-registrar/login" className="font-bold text-violet-450 hover:text-violet-300 hover:underline">
                  Sign in here
                </Link>
              </p>
            </form>
          ...
          <Card theme="dark" noPad className="p-8 flex flex-col items-center gap-6 border border-violet-500/20 bg-slate-900/60 backdrop-blur-md shadow-2xl">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400 mt-2">
                Your <span className="font-semibold text-violet-400">Academic Registrar</span> account for{" "}
            ...
            <Button
              ...
              size="lg"
              fullWidth
              onClick={() => router.push("/admin/academic-registrar/login")}
