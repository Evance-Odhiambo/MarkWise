...
const NAV = [
  ...
  { label: "Campuses",    href: `${BASE}/dashboard/campuses`,     icon: Landmark,        color: "text-emerald-400" },
      ...
      <div className="border-t border-white/10 px-3 py-4">
        <button
          onClick={async () => {
            ...
            window.location.href = "/admin/system-admin/login";
          }}
...
export default function SystemAdminLayout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    fetch("/api/auth/me", { credentials: "include" })
      ...
      .then(data => {
        if (!data) { router.push("/admin/system-admin/login"); return; }
        setAdmin({
          id: data.id,
      ...
      .catch(() => router.push("/admin/system-admin/login"));
  }, [router, isPublicPath]);
